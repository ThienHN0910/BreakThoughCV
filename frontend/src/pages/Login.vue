  ...
  <div class="flex min-h-screen items-center justify-center px-4 py-8">
    <div class="grid w-full max-w-5xl gap-5 lg:grid-cols-[1.15fr_1fr]">
      <div class="btc-card hidden lg:block">
        <p class="inline-block rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wider" :style="{ background: 'var(--btc-primary-2)', color: '#fff' }">BreakThroughCV</p>
        <h1 class="mt-4 text-4xl font-bold leading-tight">Đăng nhập nhanh<br />để tối ưu CV và tuyển dụng.</h1>
        <p class="mt-3" :style="{ color: 'var(--btc-muted)' }">Candidate có thể đánh giá CV theo JD bằng AI, recruiter quản lý tin tuyển dụng và hồ sơ ứng viên tại cùng một nơi.</p>
      </div>

      <div class="btc-card w-full md:p-8">
        <h2 class="text-2xl font-bold">Đăng nhập</h2>
        <p class="mb-6 mt-2 text-sm" :style="{ color: 'var(--btc-muted)' }">Sử dụng Google để truy cập hệ thống.</p>
